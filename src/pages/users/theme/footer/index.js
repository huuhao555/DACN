           ...
           <div className="row">
                ...
                <div className="col-lg-3 .col-sm-6 col-xs-12">
                    <div className="footer-about">
                        <img  src={require('../../../../assets/users/logo.png')}/>
                        <ul>
                            <li>Địa chỉ: 18A/1 Cộng Hòa, Phường 4</li>
                            <li>Phone: <Link to="" style={{ textDecoration: 'none', color: '#1c1c1c'}}>0987-654-321</Link></li>
                ...
                <div className="col-lg-6 .col-sm-6 col-xs-12">
                    <div className="footer-info">
                        ...
                        <ul>
                            ...
                            <li> <Link to="#">Mua hàng trả góp Online</Link> </li>
                            <li> <Link to="#">Tra cứu hoá đơn điện tử</Link> </li>
                            <li> <Link to="#">Chính sách khui hộp sản phẩm Apple</Link> </li>
                            <li> <Link to="#">Mua hàng và thanh toán Online</Link> </li>
                            <li> <Link to="#">Chính sách bảo mật thông tin cá nhân</Link> </li>
                        </ul>
                        <div className="footer-qr">
                            <div className="qr">
                                <img style={{width: '90px'}} src={require('../../../../assets/users/qrtest.png')} />
                            </div>
                            <div className="operating-system">
                                <img style={{width: '100px', display: 'flex', cursor: 'pointer'}} src={require('../../../../assets/users/android.webp')} />
                                <img style={{width: '100px', cursor: 'pointer'}} src={require('../../../../assets/users/ios.webp')} />
                            </div>
                        </div>
                    </div>
                </div>
